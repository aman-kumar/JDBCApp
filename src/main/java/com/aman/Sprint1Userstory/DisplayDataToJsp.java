...
public class DisplayDataToJsp extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        /*
         * pw.println(
         * "it's time to display the details of the person whose name is just enetered"
         * ); pw.println("The userId: "+id); pw.println("The username: "+user);
        ...
        RequestDispatcher view = request
                .getRequestDispatcher("ViewDatabaseContent.jsp");
