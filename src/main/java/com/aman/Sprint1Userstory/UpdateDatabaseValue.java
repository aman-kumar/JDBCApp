...
public class UpdateDatabaseValue extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        // String sql="UPDATE aman_table SET password ="+
        // newPassword+",email= "+newEmail+", country="+newCountry+"WHERE Id ="+userId
        // ;
        ...
        try {
            ...
            try {
                pst = con.prepareStatement("UPDATE aman_table set password=?"
