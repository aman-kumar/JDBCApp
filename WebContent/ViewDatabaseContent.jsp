...
String userpassword=(String)request.getAttribute("userpasswordvalue");
String useremail=(String)request.getAttribute("useremailvalue");
String usercountry=(String)request.getAttribute("usercountryvalue");
%>
<body>

<h1>Here we will display the details of the Entered Id number in the Form page</h1>
UserId:<%=id %><br>
UserName:<%=user %><br>
